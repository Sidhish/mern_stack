...
//     const second = document.getElementsByName("Last Name")[0].value;
//     console.log("Last name is: ",second);
//     if(second.length<1) {
...
//     if(email.length<1) alert("Email should not be empty!!");
//     let res = false;
...
//     if(pass.length < 8) alert("Password must be greater than 8 charaters...")
// }
...
function toggle() {
  ...
  form.classList.toggle("form3");
  form.classList.toggle("form4");
}
